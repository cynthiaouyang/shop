...
//		}   
		...
		String[] l1={"FAQ","SIZE", "CHARTS","ORDER HELP","SHIPPING & HANDLING","RETURNS & EXCHANGES","GIFT CARDS & MERCHANDISE CREDIT","CUSTOMER SERVICE"};

		String[] l2={"BRAND","PROTECTION","CAREERS"};
		String[] l3={"PRIVACY / AD COOKIES","SALE TERM","TEXT TERMS & PRIVACY POLICY","WEBSITE TERMS OF USE","ENDORSEMENTS SOCIAL MEDIA ENGAGEMENT","SITE MAP"};
	    ...
	    sc.setAttribute("mainnail",new String[] {"NEW IN TODAY","THE NEW COLLECTION","NIGHT OUT DRESSES","ALL NEW ACCESSOR","WARMER WINTER","SPRING COLLECTION","MEN'S JACKETS","GIFT OPTIONS"});
	}
